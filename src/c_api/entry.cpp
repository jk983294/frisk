...
__attribute__((visibility("default"))) void fit(void* model, const double* x, const double* y, long nobs,
...
__attribute__((visibility("default"))) void free_predicted_y(double* y) {
    delete []y;
}
}